...
!  DIMENSIONS FROM FILE  A10HHeCadi.dat                  
...
INTEGER(I4B), PARAMETER :: ID_FREC1 =  1600
...
!    NUMBER OF IONS
INTEGER(I4B), PARAMETER :: ID_IONES =   9
 
!    NUMBER OF L + K LEVELS
INTEGER(I4B), PARAMETER :: ID_LLEVS =   205
...
INTEGER(I4B), PARAMETER :: ID_RCBBT =  5541
 
!    NUMBER OF RBX + CBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RCBXT =     1
 
!    NUMBER OF CBS + CBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_CBSFT =   226
 
!    NUMBER OF RBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RBFTR =   202
 
!    NUMBER OF RFF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RFFTR =     6
 
!    NUMBER OF TOTAL TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTRAN =  5975
 
!   NUMBER OF RBB + RBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTTRD =  1628
 
!    NUMBER OF DATA
INTEGER(I4B), PARAMETER :: ID_NDATA = 17258
