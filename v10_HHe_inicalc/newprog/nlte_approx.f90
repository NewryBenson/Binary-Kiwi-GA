...
!
!version 7.6.0 Sept 2025:   vth10 in sub. fgrid_lines (used to calculate frequency
!                           boxes for approx. line-blocking/blanketing)
...
!  
character*10 :: ver_nlte_app='7.6.0' 
...
!Sept. 2026: changed from 10 to 5; stop should occur for vturb somewhat larger than 40 km/s
if(nsubinter_frac3.lt.5) stop ' nsubinter_frac3 lt 5' 
...
if(abs(1.-vth8/vth(8)).gt.0.075) then
