...
!  DIMENSIONS FROM FILE  A10HHeN2345.dat                 
...
INTEGER(I4B), PARAMETER :: ID_FREC1 =  1700
...
!    NUMBER OF IONS
INTEGER(I4B), PARAMETER :: ID_IONES =  10
 
!    NUMBER OF L + K LEVELS
INTEGER(I4B), PARAMETER :: ID_LLEVS =   260
...
INTEGER(I4B), PARAMETER :: ID_RCBBT =  7159
 
!    NUMBER OF RBX + CBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RCBXT =     1
 
!    NUMBER OF CBS + CBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_CBSFT =   284
 
!    NUMBER OF RBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RBFTR =   257
 
!    NUMBER OF RFF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RFFTR =     7
 
!    NUMBER OF TOTAL TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTRAN =  7707
 
!   NUMBER OF RBB + RBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTTRD =  1833
 
!    NUMBER OF DATA
INTEGER(I4B), PARAMETER :: ID_NDATA = 23535
